      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <label className="text-sm font-black">
          ...
          <select
            ...
            className="mt-2 w-full rounded-2xl border border-line bg-white/80 px-4 py-3 font-medium outline-none transition focus:border-accent focus:ring-4 focus:ring-teal-700/10"
          >
