...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "70g shelled edamame",
      "120g cucumber, carrot, and cabbage",
  ...
  {
    slug: "biltong-cheese-cucumber-box",
    title: "Biltong, Cheese & Cucumber Box",
    mealType: "Snack",
    goals: ["High protein", "Low carb", "Quick"],
    description:
      "A satisfying savoury snack box with biltong, mature cheese, and fresh cucumber.",
    ingredients: [
      "40g lean biltong",
      "30g mature cheddar",
      "150g cucumber",
    ...
    difficulty: "Easy",
    instructions: [
      "Slice the cucumber and cheese.",
      "Arrange with the biltong and mustard in a snack container.",
    ],
    tags: ["Snack", "Biltong", "Low carb", "Savory"],
  },
  {
    ...
    instructions: [
      ...
      "Add biltong, carrot, and cucumber.",
  ...
  },
  {
    ...
    goals: ["High protein", "Quick"],
    description:
      "Crunchy rice cakes topped with a light tuna mix, cucumber, and black pepper.",
    ingredients: [
    ...
    instructions: [
      ...
      "Spoon onto the rice cakes and top with cucumber.",
